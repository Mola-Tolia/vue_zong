<template>
    <div id="box">
      <form action="javascript:;" method="post">
        ...
        <span class="zt2">提交下方基本信息后可公开需求为你推荐服务商</span>
        <br /><br />

        <i class="fa-solid fa-user" style="color: #1f5137"></i>
        ...
        <i class="fa-solid fa-gear" style="color: #1f5135"></i>
        ...
        <i class="fa-solid fa-mobile-screen" style="color: #2bbf3d"></i>
        ...
        <div class="nr">
          ...
          <input
            class="ip1"
            type="text"
            v-model="zpInfo.phone"
            oninput="if(value.length>11) value=value.slice(0,11)"
            placeholder="   请输入手机号"
          />
          <div class="fgx"></div>
          <div class="yzmhq" :style="{ color: yzmys }" @click="yzman">
            获取验证码
          </div>
        ...
        <i class="fa-solid fa-building-user" style="color: #4fcf20"></i>
        ...
        <div class="nr2">
          ...
          <div class="xz" style="margin-left: 20px" @click="xz2" :class="ztxz2">
            个人
          </div>
          <div class="xz" style="margin-left: 20px" @click="xz3" :class="ztxz3">
            政府组织
          </div>
        </div>
